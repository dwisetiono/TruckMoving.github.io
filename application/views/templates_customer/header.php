...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo base_url('asserts/assets_stisla/assets/img/p-50.png'); ?>" rel="icon">
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>TRUCK<strong style="color:green;">MOVING</strong><em>.</em></h2></a>
