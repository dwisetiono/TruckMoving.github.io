        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            ...
            <div class="down-content">
              ...
              <span>Rp. <?= number_format($mb->harga,0,',','.'); ?>,-</span> <strong>Per-Kilometer</strong>
              ...
              <div class="row">
                ...
                <?php if($mb->mp3_player == '1'){ ?>
                  <a href="#" class="badge badge-success m-1"><i class="fa fa-check-square"></i> Terpal</a>
                  <?php } 
                else{ ?>
                  <a href="#" class="badge badge-danger m-1"><i class="fa fa-times-circle"></i> Terpal</a>
                <?php } ?>

                <?php if($mb->central_lock == '1'){ ?>
                  <a href="#" class="badge badge-success m-1"><i class="fa fa-check-square"></i> Tali</a>
                  <?php } 
                else{ ?>
                  <a href="#" class="badge badge-danger m-1"><i class="fa fa-times-circle"></i> Tali</a>
                <?php } ?>
              </div>
